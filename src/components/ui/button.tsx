...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-2 whitespace-nowrap border text-[0.8125rem] transition-colors outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5",
  {
    variants: {
      variant: {
        /** The one filled button on the page. There should only ever be one. */
        default: 'border-ink bg-ink text-paper hover:bg-[#262626]',
        /** Ordinary weight: black rule, white fill. */
        outline: 'border-ink bg-paper text-ink hover:bg-[#f2f2f2]',
        /** Secondary actions: grey rule and grey text until hovered. */
        quiet: 'border-field bg-paper text-muted hover:border-ink hover:text-ink',
        ...
        link: 'border-transparent text-ink underline underline-offset-4',
      },
      size: {
